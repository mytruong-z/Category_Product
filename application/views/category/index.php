...
<div class="container">
    ...
    <div id="detail">
        ...
        <?php foreach ($single_category as $cate) {?>
            ...
            <form class="border-form" method="post" action="<?php echo base_url("category/update_category_id") ?>" enctype="multipart/form-data">
                <a id="cancel"  class="cancel" href="<?php echo base_url()."category/show_category_id"?>"><span  class="glyphicon glyphicon-remove"></span></a>
    ...
    <table class="table" border="0">
        ...
        <?php foreach ($category as $value) {?>
            <tr>
                ...
                <td>
                    <a id="edit" href="<?=base_url()?>category/show_category_id/<?php echo $value["id"];?>""><button class="btn-primary">Edit</button></a>
